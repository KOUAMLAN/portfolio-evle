    ...
    <>
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-4 right-3 sm:bottom-6 sm:right-6 z-40 w-12 h-12 sm:w-14 sm:h-14 bg-blue-600 text-white rounded-full shadow-2xl flex items-center justify-center"
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            />
            <motion.div
              className="fixed z-50 left-3 right-3 bottom-3 sm:left-auto sm:right-6 sm:bottom-6 sm:w-96"
