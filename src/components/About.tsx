          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mb-4 font-medium text-secondary text-lg">
                  {ABOUT_DATA.act1_identity}
                </p>

                <p className="text-gray-600 leading-relaxed">
                  {ABOUT_DATA.act2_journey}
                </p>
          ...
          >
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div>
                ...
                <p className="mb-4 italic text-gray-300 border-l-2 border-primary pl-4">
                  "{ABOUT_DATA.act5_approach}"
                </p>


                <p className="font-semibold text-white pt-2">
                  {ABOUT_DATA.act6_ambition}
                </p>
