import{c as t,j as n,r as x,X as p,E as h,m as d,P as u,G as g}from"./index-DWBzuLvF.js";const m=t("CheckCircle2",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);const y=t("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);const f=t("Gauge",[["path",{d:"m12 14 4-4",key:"9kzdfg"}],["path",{d:"M3.34 19a10 10 0 1 1 17.32 0",key:"19p75a"}]]);const j=t("MousePointerClick",[["path",{d:"m9 9 5 12 1.8-5.2L21 14Z",key:"1b76lo"}],["path",{d:"M7.2 2.2 8 5.1",key:"1cfko1"}],["path",{d:"m5.1 8-2.9-.8",key:"1go3kf"}],["path",{d:"M14 4.1 12 6",key:"ita8i4"}],["path",{d:"m6 12-1.9 2",key:"mnht97"}]]);const k=t("Play",[["polygon",{points:"5 3 19 12 5 21 5 3",key:"191637"}]]);const v=t("Search",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);const w=t("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]),o=r=>!!(r&&!r.includes("github.com")),N=[{key:"speed",label:"Performance",icon:f,color:"text-blue-700 bg-blue-50 border-blue-200"},{key:"visibility",label:"Visibilité",icon:y,color:"text-purple-700 bg-purple-50 border-purple-200"},{key:"ergonomics",label:"Expérience utilisateur",icon:j,color:"text-green-700 bg-green-50 border-green-200"},{key:"seo",label:"SEO",icon:v,color:"text-orange-700 bg-orange-50 border-orange-200"},{key:"mobile",label:"Mobile",icon:w,color:"text-pink-700 bg-pink-50 border-pink-200"}],z=({gains:r})=>{const s=N.filter(l=>r[l.key]);return s.length===0?null:n.jsxs("div",{className:"space-y-3",children:[n.jsx("p",{className:`\r
text-xs\r
font-bold\r
uppercase\r
tracking-wide\r
...
`,children:[n.jsx(i,{size:16,className:"shrink-0 mt-0.5"}),n.jsxs("div",{children:[n.jsx("strong",{className:"block",children:a}),n.jsx("span",{children:r[l]})]})]},l))})]})},E=({project:r,onClose:s})=>(x.useEffect(()=>{if(!r)return;const l=i=>{i.key==="Escape"&&s()};document.addEventListener("keydown",l);const a=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.removeEventListener("keydown",l),document.body.style.overflow=a}},[r,s]),r?n.jsxs("div",{className:`\r
      ...
      `,role:"dialog","aria-modal":"true","aria-labelledby":"project-modal-title",children:[n.jsx("button",{type:"button",onClick:s,className:`\r
        ...
        `,children:[n.jsx("button",{type:"button",onClick:s,className:`\r
            ...
            transition\r
            z-20\r
          `,"aria-label":"Fermer",children:n.jsx(p,{size:22})}),n.jsx("h2",{id:"project-modal-title",className:`\r
            text-2xl\r
            sm:text-3xl\r
            font-bold\r
            text-secondary\r
          ...
          `,children:[n.jsxs("a",{href:r.demoLink,target:"_blank",rel:"noopener noreferrer",className:`\r
            ...
            `,children:["Ouvrir la démo",n.jsx(h,{size:18})]}),n.jsx("button",{type:"button",onClick:s,className:`\r
              ...
              hover:bg-gray-100\r
              transition\r
            `,children:"Fermer"})]})]})]}):null),P="/assets/home-banner-C5thFDoB.png",L=()=>{const[r,s]=x.useState(null),l=e=>{o(e.demoLink)?s(e):window.open(e.demoLink,"_blank","noopener,noreferrer")},a=()=>{s(null)},i=e=>{e.currentTarget.src=P};return n.jsxs("section",{id:"projects",className:`
        py-16
        sm:py-24
        bg-gray-50
        overflow-hidden
      `,children:[n.jsxs("div",{className:`
        ...
        `,children:[n.jsxs(d.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},className:`
          ...
          `,children:[n.jsx("h2",{className:`
            ...
            md:grid-cols-2
            gap-8
          `,children:u.map((e,b)=>n.jsxs(d.article,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{delay:b*.1},className:`
                bg-white
                rounded-xl
                overflow-hidden
                shadow-lg
              ...
              `,children:[n.jsxs("button",{type:"button",onClick:()=>l(e),"aria-label":`Voir la démonstration ${e.title}`,className:`
                ...
                `,children:[n.jsx("img",{src:e.image,alt:`Aperçu du projet ${e.title}`,width:"800",height:"450",loading:"lazy",decoding:"async",onError:i,className:`
                  ...
                  `,children:n.jsxs("span",{className:`
                      ...
                      font-semibold
                      shadow-lg
                    `,children:[n.jsx(k,{size:18,className:`
                        text-primary
                        fill-primary
                ...
                `,children:[n.jsx("h3",{className:`
                  ...
                  `,children:e.tags.map(c=>n.jsx("span",{className:`
                    ...
                    leading-relaxed
                    mb-5
                  `,children:e.description}),e.gains&&n.jsx("div",{className:"mb-5",children:n.jsx(z,{gains:e.gains})}),n.jsxs("div",{className:`
                    bg-gray-50
                    rounded-lg
                    border
                    p-4
                  ...
                  `,children:[n.jsxs("div",{className:`
                      ...
                      gap-2
                      text-sm
                    `,children:[n.jsx(m,{size:17,className:"text-green-600"}),n.jsxs("p",{children:[n.jsx("strong",{children:"Objectif :"})," ",e.objectives]})]}),n.jsxs("div",{className:`
                      flex
                      gap-2
                      text-sm
                    `,children:[n.jsx(m,{size:17,className:"text-blue-600"}),n.jsxs("p",{children:[n.jsx("strong",{children:"Résultat :"})," ",e.results]})]})]}),n.jsxs("div",{className:`
                    mt-auto
                    pt-4
                    border-t
                    flex
                    ...
                    sm:flex-row
                    gap-3
                  `,children:[n.jsxs("a",{href:e.repoLink,target:"_blank",rel:"noopener noreferrer",className:`
                      flex
                      items-center
                      justify-center
                      gap-2
                      font-semibold
                      min-h-[44px]
                    `,children:[n.jsx(g,{size:18}),"Code"]}),n.jsxs("button",{type:"button",onClick:()=>l(e),className:`
                      flex
                      items-center
                      justify-center
                      gap-2
                      ...
                      min-h-[44px]
                      font-semibold
                    `,children:["Voir projet",n.jsx(h,{size:16})]})]})]})]},e.id))})]}),n.jsx(E,{project:r,onClose:a})]})};export{L as default};
